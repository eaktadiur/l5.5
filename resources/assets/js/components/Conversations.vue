            ...
            <div class="media" v-for="conversation in conversations" v-else-if="conversations.length">
                <div class="media-body">
                    ...
                    <ul class="list-inline">
                        <li>
                            <img v-bind:src="user.avatar" v-bind:title="user.name" v-bind:alt="user.name + ' avatar'" v-for="user in conversation.users.data" class='img-circle'>
                        </li>
...
<style type="text/css">
    ul.list-inline li img{margin-left: 2px;}
</style>
